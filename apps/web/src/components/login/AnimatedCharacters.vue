...
let yellowBlinkTimeout: ReturnType<typeof setTimeout> | null = null
...
const calculatePosition = (centerX: number, centerY: number, mx: number, my: number, rangeX = 15, rangeY = 10, minX: number | null = null, maxX: number | null = null, minY: number | null = null, maxY: number | null = null) => {
